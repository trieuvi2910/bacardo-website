...
export default function Header({ isWalletConnected, onWalletConnect }: HeaderProps) {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const sections = ["hero", "how-to-buy", "token", "tokenomics", "music", "media", "roadmap"];
            ...
            <nav className="nav">
                <div className="nav-container">
                    <div className="logo" onClick={scrollToTop} style={{ cursor: "pointer" }}>
                        <img src="/assets/logo.png" alt="$Bardo Logo" className="logo-img" />
                        <h2>$Bardo</h2>
                    </div>
                    <ul className="nav-menu">
                        ...
                        <li>
                            <a
                                href="#how-to-buy"
                                className={activeSection === "how-to-buy" ? "active" : ""}
                                onClick={(e) => {
                                    e.preventDefault();
                        ...
                        <li>
                            <a
                                href="#token"
                                className={activeSection === "token" ? "active" : ""}
                                onClick={(e) => {
                                    e.preventDefault();
                    ...
                    <div className="nav-buttons">
                        {/* {connectedWallet ? (
                            ...
                            <button className="btn btn-gradient connect-wallet-btn" id="headerWalletBtn" onClick={toggleWalletPopup}>
                                Get $Bardo
                            </button>
                        )} */}
                    ...
                    <div className="wallet-popup">
                        ...
                        <div className="wallet-popup-content">
                            <div
                                ...
                                onClick={() => !isConnecting && connectWallet("metamask")}
                            >
